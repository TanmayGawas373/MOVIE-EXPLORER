          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="glass rounded-2xl p-6 sticky top-8">
                <motion.img
                  src={movieDetails.imgPoster || 'https://images.pexels.com/photos/7991579/pexels-photo-7991579.jpeg?auto=compress&cs=tinysrgb&w=600'}
                ...
                {movieDetails.imdbRating && (
                  ...
                  >
                    ...
                    <span className="text-2xl font-bold text-white">{movieDetails.imdbRating}</span>
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    { icon: DollarSign, label: 'Box Office', value: movieDetails.boxoffice },
                  ].map((item, index) => (
                    item.value && (
                      <motion.div
                        key={index}
              ...
              {(movieDetails.imdbRating || movieDetails.imdbVotes) && (
                <motion.div
                  ...
                  className="glass rounded-2xl p-8"
                >
                  <h2 className="text-2xl font-bold text-white mb-6">IMDb Statistics</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {movieDetails.imdbRating && (
                      <div className="flex items-center gap-4 p-4 bg-yellow-500/10 rounded-xl border border-yellow-500/20">
                        ...
                        <div>
                          ...
                          <p className="text-2xl font-bold text-white">{movieDetails.imdbRating}/10</p>
                        </div>
                      </div>
                    )}
                    {movieDetails.imdbVotes && (
                      <div className="flex items-center gap-4 p-4 bg-blue-500/10 rounded-xl border border-blue-500/20">
                        ...
                        <div>
                          ...
                          <p className="text-2xl font-bold text-white">{movieDetails.imdbVotes}</p>
                        </div>
                      </div>
                    )}
                  </div>
